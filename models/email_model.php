...
class Email_Model extends Model
{
    ...
    function sendEmail($email = 'lallen@theparafirm.com'){
        ...
        $headers .= "Reply-To: info.thisbetterfugginwork.com\r\n";
        $headers .= "CC: ".QUIZ_CC."\r\n";
        ...
        if(mail($to,$subject,$message,$headers)){
            header('Location: '.URL.'share/success/');
        }else{
            header('Location: '.URL.'error/index/email/');
        }
    }
}